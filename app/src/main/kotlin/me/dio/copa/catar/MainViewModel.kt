...
class MainViewModel @Inject constructor(
    ...
    private fun fetchMatches() = viewModelScope.launch {
        getMatchesUseCase().flowOn(Dispatchers.Main).catch {
            when(it){
...
sealed class MainUiAction {
    ...
    data class EnableNotification(val matchDomain: MatchDomain) : MainUiAction()
    data class DisableNotification(val matchDomain: MatchDomain) : MainUiAction()
}